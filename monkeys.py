...
monkey_dict = {
    1: Monkey("ninja", 340, 'd', [295, 295, 720, 2335, 29750, 295, 425, 765, 4420, 18700, 210, 340, 2335, 3825, 34000]),
    2: Monkey("bomb", 445, 'e', [295, 550, 1020, 3060, 46750, 210, 340, 930, 2720, 21250, 170, 255, 680, 2380, 29750])
}
